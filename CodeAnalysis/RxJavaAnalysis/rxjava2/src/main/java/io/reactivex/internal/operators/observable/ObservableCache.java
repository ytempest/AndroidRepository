...
public final class ObservableCache<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    /**
     * Creates a cached ObservableSource with a default capacity hint of 16.
     * @param <T> the value type
     * @param source the source ObservableSource to cache
    ...
    /**
     * Creates a cached ObservableSource with the given capacity hint.
     * @param <T> the value type
     * @param source the source ObservableSource to cache
    ...
    /**
     * Private constructor because state needs to be shared between the ObservableSource body and
    ...
    static final class CacheState<T> extends LinkedArrayList implements Observer<T> {
         ...
         * ObservableSource was forcefully terminated.
         */
        boolean sourceDone;
