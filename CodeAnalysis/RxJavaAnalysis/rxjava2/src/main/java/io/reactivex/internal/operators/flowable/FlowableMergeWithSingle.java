...
/**
 * Merges an ObservableSource and a Maybe by emitting the items of the ObservableSource and the success
 * value of the Maybe and waiting until both the ObservableSource and Maybe terminate normally.
 *
