...
/**
 * Merges an ObservableSource and a Completable by emitting the items of the ObservableSource and waiting until
 * both the ObservableSource and Completable complete normally.
 *
