...
public abstract class Completable implements CompletableSource {
     ...
     * </dl>
     * @param <T> the type of the ObservableSource
     * @param observable the ObservableSource instance to subscribe to, not null
     * @return the new Completable instance
     ...
     * thrown by either the sources ObservableSource or the inner Completable instances.
     * <dl>
     *  <dt><b>Backpressure:</b></dt>
     ...
     * @param sources the iterable sequence of sources.
     * @param maxConcurrency the maximum number of concurrent subscriptions
     * @param delayErrors delay all errors from the mainThread source and from the inner Completables?
     * @return the new Completable instance
     * @throws NullPointerException if sources is null
     * @throws IllegalArgumentException if maxConcurrency is less than 1
     */
    ...
    /**
     * Returns an ObservableSource which will subscribe to this Completable and once that is completed then
     ...
     * @return ObservableSource that composes this Completable and next
     ...
     * @param onComplete the runnable called subscriber before when this Completable completes normally
    ...
    /**
     * Returns a Completable instance that calls the given onTerminate callback subscriber before this Completable
     * completes normally or with an exception.
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code doOnTerminate} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     * @param onTerminate the callback to call subscriber before this Completable terminates
     * @return the new Completable instance
     * @see #doFinally(Action)
     */
    @CheckReturnValue
    ...
    /**
     * Returns an ObservableSource which first delivers the events
     * of the other ObservableSource then runs this CompletableConsumable.
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code startWith} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
    ...
    /**
     * Returns an ObservableSource which when subscribed to subscribes to this Completable and
     * relays the terminal events to the subscriber.
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * </dl>
     * @param <T> the value type
     * @return the new ObservableSource created
     */
    @CheckReturnValue
    @SuppressWarnings("unchecked")
    @SchedulerSupport(SchedulerSupport.NONE)
