...
public final class QueueDrainHelper {
     ...
     * In this case, the onComplete() can't subscriber emit the contents of the queue but has to
...
//        }
    ...
    /**
     * Signals the completion of the mainThread sequence and switches to post-completion replay mode.
     *
     * <p>
