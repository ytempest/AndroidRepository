...
public final class BehaviorProcessor<T> extends FlowableProcessor<T> {
     ...
     *            {@link BehaviorProcessor} has not yet observed any items from its source {@code ObservableSource}
     * @return the constructed {@link BehaviorProcessor}
     */
    @CheckReturnValue
    @NonNull
     ...
     * <p>
     * This method should be called in a sequential manner subscriber like the onXXX methods
