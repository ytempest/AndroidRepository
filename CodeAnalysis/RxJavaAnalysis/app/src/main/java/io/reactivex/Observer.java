 ...
 * </ul>
 * From the {@code ObservableSource}'s perspective, an {@code Observer} is the end consumer thus it is the {@code Observer}'s
 ...
 * @see <a href="http://reactivex.io/documentation/observable.html">ReactiveX documentation: ObservableSource</a>
 * @param <T>
...
public interface Observer<T> {
     ...
     *
     * @param t
     *          the item emitted by the ObservableSource
     */
     ...
     *
     * @param e
     *          the exception encountered by the ObservableSource
     */
