...
public final class IoScheduler extends Scheduler {
    ...
    /**
     * Description：这是RxJava自定义的一个线程池，用法跟系统的线程池差别不大
     */
    ...
    public IoScheduler() {
        // WORKER_THREAD_FACTORY会在本类中的静态代码块中被初始化
        // WORKER_THREAD_FACTORY是一个 ThreadFactory对象，即一个线程工厂
    ...
    public IoScheduler(ThreadFactory threadFactory) {
        this.threadFactory = threadFactory;
        // 为 NONE对象（CachedWorkerPool对象，RxJava自定义的一个线程池）创建一个原子性引用，保证
    ...
    static final class EventLoopWorker extends Scheduler.Worker {
        ...
        /**
         * 这个对象获取就是在 IOScheduler中静态代码块中实例化的
         * new ThreadWorker(new RxThreadFactory("RxCachedThreadSchedulerShutdown")) 对象
         */
        ...
        public Disposable schedule(@NonNull Runnable action, long delayTime, @NonNull TimeUnit unit) {
             ...
             * scheduleActual方法会把执行单元交给线程池处理
             * {@link NewThreadWorker}
             */
