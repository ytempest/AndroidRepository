...
/**
 * Merges an ObservableSource and a Single by emitting the items of the ObservableSource and the success
 * value of the Single and waiting until both the ObservableSource and Single terminate normally.
 *
 * @param <T> the element type of the ObservableSource
