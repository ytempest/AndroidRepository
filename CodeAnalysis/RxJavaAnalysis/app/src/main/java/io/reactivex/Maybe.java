 ...
 * <p>
 * The mainThread consumer type of Maybe is {@link MaybeObserver} whose methods are called
 * in a sequential fashion following this protocol:<br>
 * {@code onSubscribe (onSuccess | onError | onComplete)?}.
 * <p>
 * Note that {@code onSuccess}, {@code onError} and {@code onComplete} are mutually exclusive events; unlike {@code ObservableSource},
...
public abstract class Maybe<T> implements MaybeSource<T> {
     ...
     * an error notification from one of them or even the mainThread Publisher.
     * <p>
     * This behaves like {@link #merge(Publisher)} except that if any of the merged MaybeSources notify of an
     * error via {@link Subscriber#onError onError}, {@code mergeDelayError} will refrain from propagating that
     * error notification until all of the merged MaybeSources and the mainThread Publisher have finished emitting items.
     * <p>
     * <img width="640" height="380" src="https://raw.github.com/wiki/ReactiveX/RxJava/images/rx-operators/mergeDelayError.png" alt="">
     * <p>
     ...
     * Flattens a Publisher that emits MaybeSources into one Publisher, in a way that allows a Subscriber to
     * receive all successfully emitted items from all of the source MaybeSources without being interrupted by
     * an error notification from one of them or even the mainThread Publisher as well as limiting the total number of active MaybeSources.
     * <p>
    ...
    /**
     * Constructs a Maybe that creates a dependent resource object which is disposed of subscriber before
     ...
     *            the function that will dispose of the resource
     * @param eager
     *            if {@code true} then disposal will happen either on a dispose() call or subscriber before emission of
    ...
    /**
     * Returns an ObservableSource that maps a success value into an Iterable and emits its items.
     * <p>
    ...
    /**
     * Returns an ObservableSource that is based on applying a specified function to the item emitted by the source Maybe,
     ...
     * @return the ObservableSource returned from {@code func} when applied to the item emitted by the source Maybe
     * @see <a href="http://reactivex.io/documentation/operators/flatmap.html">ReactiveX operators documentation: FlatMap</a>
     */
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
     ...
     * source {@link Maybe}, where that function returns a {@link Single}.
     * When this Maybe subscriber completes the resulting {@code Maybe} completes as well.
     * <p>
     * <img width="640" height="356" src="https://raw.github.com/wiki/ReactiveX/RxJava/images/rx-operators/Maybe.flatMapSingle.png" alt="">
     * <dl>
     * <dt><b>Scheduler:</b></dt>
    ...
    /**
     * Converts this Maybe into an ObservableSource instance composing cancellation
     * through.
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     ...
     * <p>Usage example:
     * <pre><code>
     * Maybe&lt;Integer&gt; source = Maybe.subscriber(1);
     ...
     *
     * @param other
     *              the alternate MaybeSource to subscribe to if the mainThread does not emit any items
     ...
     *
     * @param other
     *              the alternate SingleSource to subscribe to if the mainThread does not emit any items
