 ...
 * overload resolution conflict with {@code ObservableSource.create} that creates an ObservableSource, not a {@code BehaviorSubject}).
 * <p>
 ...
 *
 * ObservableSource&lt;Integer&gt; observable = subject.filter(v -&gt; v != EMPTY);
 *
...
public final class BehaviorSubject<T> extends Subject<T> {
     ...
     *            {@link BehaviorSubject} has not yet observed any items from its source {@code ObservableSource}
     * @return the constructed {@link BehaviorSubject}
     */
    @CheckReturnValue
    @NonNull
