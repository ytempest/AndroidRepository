 ...
 * can wait for all intended {@link Observer}s to {@link Observable#subscribe} to the {@code ObservableSource}
 * before the {@code ObservableSource} begins emitting items.
 * <p>
...
public abstract class ConnectableObservable<T> extends Observable<T> {
    ...
    /**
     * Returns an {@code ObservableSource} that stays connected to this {@code ConnectableObservable} as long as there
    ...
    /**
     * Returns an ObservableSource that automatically connects (at most once) to this ConnectableObservable
     ...
     * during the lifetime of the returned ObservableSource. If this ConnectableObservable
     ...
     *
     * @return an ObservableSource that automatically connects to this ConnectableObservable
     *         when the first Observer subscribes
     */
    @NonNull
