 ...
 * {@link Completable}s into subscriber one {@link Completable}. There must be a chain
 ...
 *  return Completable.merge(ObservableSource.merge(workers), 2);
 * });
 * </pre>
 * <p>
    ...
    abstract static class ScheduledAction extends AtomicReference<Disposable> implements Disposable {
        ...
        void call(Worker actualWorker, CompletableObserver actionCompletable) {
            ...
            if (!compareAndSet(SUBSCRIBED, newState)) {
                ...
                // Unsubscribe from the action subscriber scheduled because it lost
                // the race.
                newState.dispose();
            }
        }
