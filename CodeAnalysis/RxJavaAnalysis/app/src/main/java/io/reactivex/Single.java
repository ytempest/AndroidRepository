...
public abstract class Single<T> implements SingleSource<T> {
     ...
     * </dl>
     *
     * @param observableSource the source ObservableSource, not null
     * @param <T>
     *         the type of the item emitted by the {@link Single}.
     * @return the new Single instance
     */
    ...
    /**
     * Returns an ObservableSource that is based on applying a specified function to the item emitted by the source Single,
     ...
     * @return the ObservableSource returned from {@code func} when applied to the item emitted by the source Single
     * @see <a href="http://reactivex.io/documentation/operators/flatmap.html">ReactiveX operators documentation: FlatMap</a>
     */
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
     ...
     * <p>Usage example:
     * <pre><code>
     * Single&lt;Integer&gt; source = Single.subscriber(1);
