package com.ytempest.okhttpanalysis.download.task.db;

import android.database.sqlite.SQLiteDatabase;
import android.os.Environment;

import com.ytempest.okhttpanalysis.download.task.config.DBConfigure;
...
public class DaoSupportFactory {
    ...
    private DaoSupportFactory() {
        ...
        File dbRoot = new File(DBConfigure.TASK_DATABASE_DIR);
        if (!dbRoot.exists()) {
            dbRoot.mkdirs();
        }
        File dbFile = new File(dbRoot, DBConfigure.TASK_DATABASE);
