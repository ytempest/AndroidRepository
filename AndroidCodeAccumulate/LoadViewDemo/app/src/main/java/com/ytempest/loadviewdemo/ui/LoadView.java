...
public class LoadView extends LinearLayout {
    ...
    private float getAnimationHeight() {
        ViewGroup.MarginLayoutParams shapeViewMargin = (MarginLayoutParams) mShapeView.getLayoutParams();
        ViewGroup.MarginLayoutParams shadowViewMargin = (MarginLayoutParams) mShadowView.getLayoutParams();
